...
QBCore.Functions.CreateUseableItem("fishingloot", function(source, item)
	...
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
		...
		TriggerClientEvent('QBCore:Notify', src, "Öppna låda", "primary")
		SetTimeout(1000, function()
			...
			TriggerClientEvent('QBCore:Notify', src, "Du hittade ett par föremål och $"..Config.smallLootboxCash, "success")
		end)
    end
end)
...
QBCore.Functions.CreateUseableItem("fishtacklebox", function(source, item)
	...
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
		...
		TriggerClientEvent('QBCore:Notify', src, "Öppning av tackle låda", "success")
...
RegisterNetEvent("fishing:server:addTackleBox", function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
	TriggerClientEvent('QBCore:Notify', src, "Det tycks ha blivit över från en annan fiskare", "primary")
	SetTimeout(1000, function()
...
RegisterNetEvent("fishing:server:returnDeposit", function()
	...
	TriggerClientEvent('QBCore:Notify', src, "Båten har återlämnats för $"..price, "success")
end) 
    ...
    if itemFound then
        for i = 1, itemCount, 1 do
            if luck == 100 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fångade en späckhuggare! Dessa är utrotningshotade arter och är olagliga att äga", "primary")
			elseif luck >= 95 and luck <= 100 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du hittade en skattkista!", "success")
			elseif luck >= 90 and luck <= 95 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fångade en delfin! Dessa är utrotningshotade arter och är olagliga att äga", "primary")
			elseif luck >= 85 and luck <= 90 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fångade en hammarhaj! Dessa är utrotningshotade arter och är olagliga att äga", "primary")
			elseif luck >= 80 and luck <= 85 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fångade en tigerhaj! Dessa är utrotningshotade arter och är olagliga att äga", "primary")
			elseif luck >= 75 and luck <= 80 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fångade en "..weight.."lbs Stingray!", "success")
			elseif luck >= 70 and luck <= 75 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fångade en " .. weight .. "lbs flundra", "success")
			elseif luck >= 65 and luck <= 70 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fångade en fiskekänga!", "primary")
			elseif luck >= 60 and luck <= 65 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fångade en " .. weight .. "lbs bas", "success")
			elseif luck >= 55 and luck <= 60 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du hittade en liten låda!", "success")
			elseif luck >= 50 and luck <= 55 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fångade en " .. weight .. "lbs torsk", "success")
			elseif luck >= 45 and luck <= 50 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fångade en fiskepanna!", "primary")
			elseif luck >= 0 and luck <= 45 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fångade en " .. weight .. "lbs makrill", "success")
            end
            Citizen.Wait(500)
        end
    end
...
RegisterNetEvent('fishing:server:SellillegalFish', function(args)
	...
	if args == 1 then 
		...
		if dolphin ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Delfin säljs för $"..payment, "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Du har ingen delfin att sälja", 'error')
		end
	elseif args == 2 then 
		...
		if sharktiger ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Tiger Haj Såld för $"..payment, "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Du har ingen tigerhaj att sälja", 'error')
		end
	elseif args == 3 then 
		...
		if sharkhammer ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Hammar Haj Såld för $"..payment, "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Du har ingen Hammerhead Shark att sälja", 'error')
		end
	else
		...
		if killerwhale ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Späckhuggare säljs för $"..payment, "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Du har ingen späckhuggare att sälja", "error")
		end
	end
end)
...
RegisterNetEvent('fishing:server:SellLegalFish', function(args) 
	...
	if args == 1 then 
		...
		if mackerel ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "1 Makrill Såld för $"..payment, "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('QBCore:Notify', src, "Du har inga makrillar att sälja", "error")
		end
	elseif args == 2 then
		...
		if codfish ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "1 torsk säljs för $"..payment, "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('QBCore:Notify', src, "Du har inga torskar att sälja", "error")
		end
	elseif args == 3 then
		...
		if bass ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "1 havsabborre säljs för $"..payment, "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Du har ingen havsabborre att sälja", "error")
		end
	elseif args == 4 then
		...
		if flounder ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "1 flundra säljs för $"..payment, "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('QBCore:Notify', src, "Du har inga flundror att sälja", "error")
		end
	else
		...
		if stingray ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "1 spjutrocka såld för $"..payment, "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('QBCore:Notify', src, "Du har ingen Spjutrocka att sälja", "error")
		end
	end
end)
...
QBCore.Functions.CreateCallback('fishing:server:checkMoney', function(source, cb)
    ...
    if bankBalance >= price then
		...
		TriggerClientEvent('QBCore:Notify', src, "Båt har hyrts för $"..price, "success")
        cb(true)
    else
        TriggerClientEvent('QBCore:Notify', src, "Du har inte tillräckligt med pengar..", "error")
        cb(false)
