...
dispatchCodes = {
	...
	["officerdown"] =  {displayCode = '10-99', description = "Polis Nere", radius = 15, recipientList = {'police'}, blipSprite = 526, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "panicbutton"},
	["emsdown"] =  {displayCode = '10-99', description = "Sjukvård Nere", radius = 15, recipientList = {'police', 'ambulance'}, blipSprite = 526, blipColour = 3, blipScale = 1.5, blipLength = 2, sound = "panicbutton"},
