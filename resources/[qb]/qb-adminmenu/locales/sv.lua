local Translations = {
    error = {
        ...
        ["no_store_vehicle_garage"] = "Du kan inte förvara detta fordon i ditt garages..", 
        ["no_vehicle"] = "Du är inte i ett fordon..",
        ["no_weapon"] = "Du har inget vapen i dina händer..",
        ["no_free_seats"] = "Fordonet har inga lediga säten!",
    ...
    success = {
        ...
        ["receive_reports"] = "Du får rapporter",
    },
    info = {
        ...
        ["model"] = "Model",
        ["hash"] = "Hash",
        ["eng_health"] = "Motorns hälsa:",
        ["body_health"] = "Kroppshälsa:",
        ["goto"] = "Gå till", 
        ["remove"] = "Ta bort",
        ["confirm"] = "Bekräfta",
        ...
        ["server_restart"] = "Server startas om, Kolla in vår Discord för mer information: ",
    },
    menu = {
        ["admin_menu"] = "Admin-menyn",
        ["admin_options"] = "Administratörsalternativ",
        ["online_players"] = "Spelare online",
        ["manage_server"] = "Hantera server",
        ["weather_conditions"] = "Tillgängliga väderalternativ",
        ["dealer_list"] = "Försäljar Lista",
        ["ban"] = "Banlyss",
        ["kick"] = "Kicka",
        ["permissions"] = "Tillgångar",
        ["developer_options"] = "Utvecklar Inställningar",
        ["vehicle_options"] = "Fordons Inställningar",
        ["vehicle_categories"] = "Fordons Katigorier",
